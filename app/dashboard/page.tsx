...
export default function Page() {
    ...
    const photos = [
        { id: 1, url: "http://localhost:3000/homepage/previews/1.png", alt: "Photo 1" },
        { id: 2, url: "http://localhost:3000/homepage/previews/2.png", alt: "Photo 2" },
        { id: 3, url: "http://localhost:3000/homepage/previews/3.png", alt: "Photo 3" },
        { id: 4, url: "http://localhost:3000/homepage/previews/4.png", alt: "Photo 4" },
        { id: 5, url: "http://localhost:3000/homepage/previews/5.png", alt: "Photo 5" },
        { id: 6, url: "http://localhost:3000/homepage/previews/1.png", alt: "Photo 6" },
        { id: 7, url: "http://localhost:3000/homepage/previews/2.png", alt: "Photo 7" },
        { id: 8, url: "http://localhost:3000/homepage/previews/3.png", alt: "Photo 8" },
        { id: 9, url: "http://localhost:3000/homepage/previews/4.png", alt: "Photo 9" },
        { id: 10, url: "http://localhost:3000/homepage/previews/5.png", alt: "Photo 10" },
        { id: 11, url: "http://localhost:3000/homepage/previews/1.png", alt: "Photo 11" },
        { id: 12, url: "http://localhost:3000/homepage/previews/2.png", alt: "Photo 12" },
        { id: 13, url: "http://localhost:3000/homepage/previews/3.png", alt: "Photo 13" },
        { id: 14, url: "http://localhost:3000/homepage/previews/4.png", alt: "Photo 14" },
        { id: 15, url: "http://localhost:3000/homepage/previews/5.png", alt: "Photo 15" },
        { id: 16, url: "http://localhost:3000/homepage/previews/1.png", alt: "Photo 16" },
        { id: 17, url: "http://localhost:3000/homepage/previews/2.png", alt: "Photo 17" },
        { id: 18, url: "http://localhost:3000/homepage/previews/3.png", alt: "Photo 18" },
        { id: 19, url: "http://localhost:3000/homepage/previews/4.png", alt: "Photo 19" },
        { id: 20, url: "http://localhost:3000/homepage/previews/5.png", alt: "Photo 20" },
    ]
