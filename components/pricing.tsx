    ...
    const plans = [
        {
            ...
            price: !referral ? 29 : (29 * 0.7).toFixed(2),
            originalPrice: 49,
            features: [
                "10 videos",
                "$2.90 per video",
        ...
        },
        {
            ...
            price: !referral ? 59 : (59 * 0.7).toFixed(2),
            originalPrice: 99,
            features: [
                "50 videos",
                "$1.18 per video",
        ...
        <div id={id} className={`${className}`}>
            <div className="max-w-5xl">
                <h2 className={cn("text-5xl text-[#1a1a1a] sm:text-5xl font-black mb-8 text-center")}>
                    <span className="text-primary underline underline-offset-8 decoration-dashed">Launch</span> Pricing
                </h2>
